...
<meta name="theme-color" content="#712cf9">
  ...
  <body class="d-flex h-100 text-center text-bg-dark" style="background-image: url('{{asset('daniel-rosini-murlocs-rpg-final4.jpg')}}');">
...
<div class="cover-container d-flex w-100 h-100 mx-auto flex-column">
  <header class="mb-auto d-flex justify-content-center bg-dark bg-opacity-75 p-3">
    ...
    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
        <li><a class="dropdown-item" href="/">Sair desse lance só que 3</a></li>
        <li><a class="dropdown-item" href="/">Sair dessa parada só que 4</a></li>
    </ul>
</div>
